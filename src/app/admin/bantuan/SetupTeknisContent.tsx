...
import { Section, Step } from "./BantuanShared";

/**
 * Setup teknis (existing content) — Apps Script, WhatsApp, Firebase, Drive, Maps, dll.
 * Dokumentasi setup one-time saat install app. Cocok untuk admin dev.
 * Content sudah ada dari implementasi awal, cuma di-restructure jadi component.
 */
export function SetupTeknisContent() {
...
// Section + Step helpers dipindah ke ./BantuanShared.tsx untuk di-share
// dengan PanduanAdmin + PanduanKasir content.
