import { ShoppingCart, Truck, Receipt, KeyRound, Bike, Wallet, Users, LayoutDashboard, Coins, Printer, IdCard, BadgeCheck, HelpCircle } from "lucide-react";
  ...
  const NAV: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/kasir/bantuan", label: "Bantuan", icon: <HelpCircle size={16} />, iconColor: "text-blue-600" },
